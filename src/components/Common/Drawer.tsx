    ...
    return (
        <div
            className={cn(
                ...
                isOpen &&
                    'fixed transition-all duration-300 ease-out inset-0 !bg-black/50 '
            )}
            onClick={() => onClose()}
        >
            <div
                ...
                className={cn(
                    'fixed top-0 right-0 bottom-0 w-full xs:w-[450px] 2xl:w-[500px] bg-white h-screen transition-all duration-300 ease-out translate-x-full z-50',
